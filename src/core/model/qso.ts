...
export function adifRecordToQso(record: AdifRecord, id = createQsoId()): Qso {
  ...
  const known = new Set([
    ...
    'RST_SENT', 'RST_RCVD', 'NAME', 'QTH', 'GRIDSQUARE', 'COMMENT', 'TX_PWR',
    'STATION_CALLSIGN', 'OPERATOR', 'MY_GRIDSQUARE', 'MY_SIG', 'MY_SIG_INFO',
    'SIG', 'SIG_INFO', 'POTA_REF', 'MY_POTA_REF', 'SOTA_REF', 'MY_SOTA_REF',
